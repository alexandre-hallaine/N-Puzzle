...
Node::Node(const Puzzle& puzzle, Heuristic *heuristic, Node *parent) : puzzle(puzzle), parent(parent), cost(parent ? parent->getCost() + 1 : 0), heuristic(heuristic->calculate(puzzle))
{
}
